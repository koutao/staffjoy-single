package com.koutao.account.service.helper;
...
import com.koutao.account.dao.GreetingRequest;
...
import com.koutao.common.config.AppConfig;
...
public class ServiceHelper {
    ...
    public void syncUserAsync(String userId) {
        ...
        for(TeamDto teamDto : workerOfList.getTeams()) {
            ...
            try {
                genericCompanyResponse = new GenericCompanyResponse(companyService.getCompany(teamDto.getCompanyId()));
            } catch (Exception ex) {
